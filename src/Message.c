...
void sbQueueMessage(const char* name, const char* message, int id) {
	gMessageQueue.queue[gMessageQueue.currentMessage].name = name;
	gMessageQueue.queue[gMessageQueue.currentMessage].id = id;
	gMessageQueue.queue[gMessageQueue.currentMessage].message = message;
